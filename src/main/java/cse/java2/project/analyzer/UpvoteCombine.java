...
public class UpvoteCombine {

    public static void main(String[] args) throws IOException, CsvException {
        String csvFile = "D:\\Thrid\\Java2\\java-project\\Java-Project\\src\\main\\resources\\data\\data500.csv";
        String tag_frequency = "D:\\Thrid\\Java2\\java-project\\Java-Project\\sorted_upvoted_tags.csv";
        ...
        for (String[] tag_frequency_line : tag_frequency_lines) {
            ...
            if (Integer.parseInt(frequency) >= 4000) {
                tags.add(tag);
            } else {
                break;
            }
        ...
        String outputFile = "sorted_upvotes_combine.csv";
